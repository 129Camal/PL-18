...
void imprime_inicial(FILE* fichInicial, char* tempo, char *nome){
	...
	fprintf(fichInicial,"\t\t<img src=\"https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/EEUMLOGO.png/200px-EEUMLOGO.png\" align=\"middle\" height=\"90\" width=\"100\"></div>\n");
	...
	fprintf(fichInicial,"\t\t\t<iframe src=\"https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=en&size=small&timezone=Europe%sFLondon\" width=\"100%s\" height=\"90\" frameborder=\"0\" seamless>\n", "%2", "%");
...
void faz_pag(FILE *fich, char *tempo, char *nome, char *pagi, char *pagc, char *video, char *audio, char *titulo, char *imagem){
